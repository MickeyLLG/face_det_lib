...
class FaceDetector:
    ...
    def __init__(self,
                 dnn_proto_text='det_cnn/assets/deploy.prototxt',
                 dnn_model='det_cnn/assets/res10_300x300_ssd_iter_140000.caffemodel'):
        """Initialization"""
...
class MarkDetector:
    ...
    def __init__(self, saved_model='det_cnn/assets/pose_model'):
        """Initialization"""
